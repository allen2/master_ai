<!-- frontend/src/views/IndustryAnalysisView.vue -->
<template>
  <div class="page-view">
    <!-- 输入栏 -->
    <el-card shadow="never" class="config-card">
      <el-form :model="form" inline class="config-form" @submit.prevent>
        <el-form-item label="产业分析需求" style="flex:1">
          <el-input v-model="form.query" placeholder="例如：分析AI产业，找到PE在100以内的标的"
...
import { useIndustryAnalysisStore } from '../stores/industryAnalysisStore.js'
