// frontend/src/stores/contrarianAnalysisStore.js
import { defineStore } from 'pinia'
import { ref } from 'vue'

/**
 * contrarianAnalysisStore：管理「热门行业逆向对立面分析」SSE 流式运行状态
 * 负责追踪分析活动进度和最终 Markdown 报告
 */
export const useContrarianAnalysisStore = defineStore('contrarianAnalysis', () => {
  /** 是否正在运行 */
  ...
  async function startAnalysis(payload) {
    ...
    try {
      ...
      const response = await fetch('/contrarian-analysis/run', {
        method: 'POST',
        headers: {
