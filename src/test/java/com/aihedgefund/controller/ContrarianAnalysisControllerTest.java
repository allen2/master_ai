...
/**
 * ContrarianAnalysisController 集成测试
 * 验证 POST /contrarian-analysis/run SSE 接口的事件流响应格式和内容
 */
@SpringBootTest
@AutoConfigureMockMvc
@Import(MockMvcAuthConfig.class)
class ContrarianAnalysisControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private ContrarianSectorResearchAgent researchAgent;
    ...
    void run_blankQuery_returns422() throws Exception {
        ...
        mockMvc.perform(post("/contrarian-analysis/run")
    ...
    void run_validQuery_streamsCompleteEventWithReport() throws Exception {
        ...
        MvcResult asyncResult = mockMvc.perform(post("/contrarian-analysis/run")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(requestBody))
        ...
        mockMvc.perform(asyncDispatch(asyncResult))
                ...
                .andExpect(content().string(containsString("Hot Sector Identification")));
    }
